...
@section('main')
    ...
    <div class="main-content">
        <section class="section">
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">{{ __('dashboard.total_employees') }}</h5>
                                            <h2 class="mb-3 font-18">{{ $totalEmployees }}</h2>
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <h2 class="mb-3 font-18">{{ $payrolls }}</h2>
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <h2 class="mb-3 font-18">{{ $expiredCount }}</h2>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">{{ __('dashboard.branch') }}</h5>
                                            <h2 class="mb-3 font-18">{{ $allBranches }}</h2>
            ...
            <div class="card mt-4 shadow-sm border-0">
                ...
                <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
                    ...
                    <div class="d-flex justify-content-center flex-grow-1">
                        ...
                        <!-- Total card -->
                        <div id="incomeTotalCard" class="card text-dark bg-light mb-0"
                            style="min-width:160px;margin-left:330px;">
                            <div class="card-body p-0 text-center">
                                <small class="d-block text-dark">{{ __('dashboard.total') }}</small>
                                <strong id="incomeTotalAmount" style="font-size:1.05rem">-</strong>
                            </div>
                        </div>
                        <div class="d-flex align-items-center" style="margin-left:330px;">

                            <div class="ms-auto">
                                <select id="incomeFilter" class="form-control" style="width:200px;">
                                    <option value="daily">Daily/يوميًا</option>
                                    <option value="weekly">Weekly/أسبوعي</option>
                                    <option value="monthly" selected>Monthly/شهريا</option>
            ...
            <div class="row g-4" id="branchCardsContainer">
                @forelse ($branches->take(10) as $branch)
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex justify-content-between action-buttons">
                                    <a href="#" class="text-info viewBranchBtn" data-id="{{ $branch->id }}"
                                        ...
                                        data-market_price="{{ $branch->market_price }}"
                                        data-rent="{{ $branch->total_rent }}"
                                        data-sale_price="{{ $branch->sale_price }}"
    ...
    <script>
        ...
        <tr id="branch-row-${branch.id}">
            ...
            <td>
                <a href="#" class="text-info" data-toggle="modal" data-target="#viewBranchModal_${branch.id}"><i class="fas fa-eye"></i></a>
                ...
                <a href="#" class="text-danger deleteBranchBtn" data-id="${branch.id}" data-url="/dashboard/branch/delete"><i class="fas fa-trash-alt"></i></a>
            </td>
        </tr>
    `;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Format numbers with separators (or add currency)
            function formatAmount(value) {
                const currency = null; // e.g. 'SAR' or 'USD'
                if (currency) {
            ...
            // Update total card
            function updateTotalCard(total, type) {
                const el = document.getElementById('incomeTotalAmount');
                if (!el) return;
                ...
                const friendlyType = type.charAt(0).toUpperCase() + type.slice(1);

                el.textContent = formatAmount(total);
                el.setAttribute('title', `${friendlyType} total`);
            }
            ...
            function loadIncomeChart(type = 'monthly') {
                ...
                fetch(`{{ route('dashboard.income.chart') }}?type=${type}`)
                    ...
                    .then(data => {
                        ...
                        if (!canvas) {
                            console.error("incomeChart canvas not found in DOM!");
                            return;
                        }
                        ...
                        const totals = data.length ? data.map(item => Number(item.total) || 0) : [0];

                        // Calculate total
                        const totalSum = data.length ?
                            totals.reduce((acc, n) => acc + n, 0) :
                            0;

                        updateTotalCard(totalSum, type);
