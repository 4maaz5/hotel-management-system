@forelse ($incomes as $income)
    <tr>
        ...
        <td>{{ $income->employee->first_name ?? 'N/A' }}</td>
        ...
        <td>
            <a href="#" class="text-secondary edit-income-btn" data-toggle="modal" data-target="#editIncomeModal"
                ...
                data-income_date="{{ $income->income_date }}"> <i class="fas fa-edit"></i> </a> <a href="#"
                class="text-danger delete-income-btn" data-toggle="modal" data-target="#deleteIncomeModal"
                data-id="{{ $income->id }}" data-type="{{ $income->type }}" data-amount="{{ $income->amount }}"> <i
