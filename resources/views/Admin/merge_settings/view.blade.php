       ...
       <main class="u-white-bg bg-white p-3" style="border-radius:15px;"">
           ...
           <div class="page-header">
               <div>
                   ...
                   <div class="page-header__subtitle">{{ __('dashboard.view_unit_merge_setting') }}
                   </div>
               </div>
           </div>
           ...
           <form method="POST" action="#">
               ...
               <div class="row mb-3">
                   <div class="col-md-3">
                       ...
                       <select class="form-select" name="block_id" disabled>
               ...
               <div class="row mb-3">
                   <div class="col-md-3">
                       ...
                       <select class="form-select" name="floor_id" disabled>
               ...
               <div class="row mb-3">
                   <div class="col-md-3">
                       ...
                       <select class="form-select" name="unit_class_id" disabled>
               ...
               <div class="row mb-3">
                   <div class="col-md-3">
                       ...
                       <select class="form-select" name="unit_a_id" required disabled>
                   ...
                   <div class="col-md-3">
                       ...
                       <select class="form-select" name="unit_b_id" required disabled>
               ...
               <div class="d-flex justify-content-end mt-4">
                   <a href="{{ route('setup-sidebar.merge_setting.index') }}" class="btn btn-primary me-3">
                       {{ __('dashboard.back') }}
                   </a>
