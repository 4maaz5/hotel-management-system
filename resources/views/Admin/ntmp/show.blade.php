...
@section('title', 'Saudi NTMP Submission Details')
    ...
    <div class="container-fluid py-3">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
            <div>
                ...
                <h3 class="mb-1">Saudi NTMP Submission Details</h3>
                <p class="text-muted mb-0">Inspect the exact simulated payload and response for this reservation event.</p>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('setup-sidebar.ntmp.index') }}" class="btn btn-outline-secondary">
                    Back to Saudi NTMP
                </a>
            </div>
        </div>
