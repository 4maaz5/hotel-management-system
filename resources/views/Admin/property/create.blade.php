@extends('layouts.app')
@section('title', __('dashboard.create_property'))
...
@section('content')
    <div class="container-fluid py-4 bg-white" style="border-radius:10px;">
        <!-- Page Header -->
        <div class="page-category">{{ __('dashboard.company_property') }}</div>
        <div class="page-header">
            <h2 class="page-header__title">{{ __('dashboard.add_property') }}</h2>
            <div class="page-header__subtitle">{{ __('dashboard.add_the_information_of_a_property') }}</div>
        </div>
        <!-- Main Form -->
        <form id="propertyForm" class="needs-validation" novalidate
            action="{{ isset($property) ? route('setup-sidebar.property.store', $property->id) : route('setup-sidebar.property.store') }}"
                        ...
                        <div class="col-md-6">
                            @php
                                ...
                                $tenantStatus = $currentTenant?->status
                                    ? ucfirst(str_replace('_', ' ', $currentTenant->status))
                                    : __('dashboard.pending');
                                $tenantExpiryDate = $currentTenant?->end_date?->format('Y-m-d');
                            @endphp
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <div class="property-info-display">
                                        ...
                                        <span class="property-info-value">
                                            <input type="date" class="form-control form-control-sm"
                                                ...
                                                value="{{ $tenantExpiryDate }}" readonly>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="phone-input-group">
                                ...
                                <input type="tel" class="form-control phone-input @error('fax') is-invalid @enderror"
                                    name="fax_number" placeholder="{{ __('dashboard.fax_number') }}"
                                    value="{{ old('fax', isset($property) ? $property->fax : '') }}">
                            </div>
                            @error('fax')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="phone-input-group">
                                ...
                                <input type="tel"
                                    ...
                                    value="{{ old('hotline', isset($property) ? $property->hotline : '') }}">
                            </div>
                            @error('hotline')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="phone-input-group">
                                ...
                                <input type="tel"
                                    ...
                                    value="{{ old('admin_mobile', isset($property) ? $property->admin_mobile : '') }}">
                            </div>
                            @error('admin_mobile')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
