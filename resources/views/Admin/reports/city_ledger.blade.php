...
@section('title', __('dashboard.city_ledger_report'))

@section('report_content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h5 class="mb-0">{{ __('dashboard.city_ledger') }}</h5>
        </div>
...
<div class="english-text">
    <h4 class="text-center mb-3">{{ __('dashboard.city_ledger_report') }}</h4>
...
<div class="arabic-text">
    <h4 class="text-center mb-3">{{ __('dashboard.city_ledger_report_ar') }}</h4>
