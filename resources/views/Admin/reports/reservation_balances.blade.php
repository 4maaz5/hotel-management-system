...
@section('title', __('dashboard.reservation_balances_report'))
                    ...
                    <tbody>
                        @forelse($reservations ?? [] as $reservation)
                            <tr>
                                ...
                                <td>{{ $reservation->unit->room_number ?? '-' }}</td>
...
<div class="english-text">
    <h4 class="text-center mb-3">{{ __('dashboard.reservation_balances_report') }}</h4>
...
<div class="arabic-text">
    <h4 class="text-center mb-3">{{ __('dashboard.reservation_balances_report_ar') }}</h4>
