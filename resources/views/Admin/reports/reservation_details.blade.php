...
@section('title', __('dashboard.reservation_details_report'))
                    ...
                    <tbody>
                        @forelse($reservations ?? [] as $reservation)
                            <tr>
                                ...
                                <td class="text-center">{{ $reservation->check_in_date->diffInDays($reservation->check_out_date) }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-4">{{ __('dashboard.no_records_found') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
...
<div class="english-text">
    <h4 class="text-center mb-3">{{ __('dashboard.reservation_details_report') }}</h4>
    ...
    <table class="table table-bordered table-sm">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="9" class="text-center">{{ __('dashboard.no_records_found') }}</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
<div class="arabic-text">
    <h4 class="text-center mb-3">{{ __('dashboard.reservation_details_report_ar') }}</h4>
    ...
    <table class="table table-bordered table-sm">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="9" class="text-center">{{ __('dashboard.no_records_found_ar') }}</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
