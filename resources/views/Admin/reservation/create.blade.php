...
@section('title', __('dashboard.new_reservation'))
    ...
    <main class="u-white-bg bg-white p-2" style="border-radius:10px;">
        <div class="container-fluid mt-4">
            ...
            <div class="res-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0">{{ __('dashboard.new_reservation') }}</h4>
                    <small>{{ __('dashboard.create_new_reservation') }}</small>
                </div>
                <div class="text-end">
            ...
            <form id="reservationForm" method="POST" action="{{ route('dashboard.reservation.store') }}">
                @csrf
                ...
                <div class="res-card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="nights" id="nights" value="1"
                                readonly>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" name="source_id" id="reservationSource">
                                ...
                                @foreach ($reservationSources as $source)
                                    <option value="{{ $source->id }}">{{ $source->masterSource->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="notes" id="notes" rows="2"
                                placeholder="{{ __('dashboard.enter_notes') }}"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="res-card mt-2">
                        ...
                        <!-- Selected Unit Info -->
                        <div class="mt-3 p-3 bg-light rounded" id="selectedUnitInfo" style="display: none;">
                            <div class="row">
                                <div class="col-md-3">
                                    <small class="text-muted">{{ __('dashboard.unit') }}</small>
                                    <div class="fw-bold" id="displayUnitNumber"></div>
                                </div>
                                <div class="col-md-3">
                                    <small class="text-muted">{{ __('dashboard.unit_type') }}</small>
                                    <div class="fw-bold" id="displayUnitType"></div>
                                </div>
                                <div class="col-md-3">
                                    <small class="text-muted">{{ __('dashboard.floor') }}</small>
                                    <div class="fw-bold" id="displayFloor"></div>
                                </div>
                                <div class="col-md-3">
                                    <small class="text-muted">{{ __('dashboard.block') }}</small>
                                    <div class="fw-bold" id="displayBlock"></div>
                                </div>
                                {{-- <div class="col-md-3">
                    ...
                    <div class="guest-hub">
                        <div class="guest-hub__top">
                            <div class="lookup-panel lookup-panel--primary">
                                ...
                                <div id="guestInfoDisplay" class="selection-card selection-card--guest d-none">
                                    <div class="selection-card__icon">
                                        <i class="bi bi-person-check"></i>
                                    </div>
                                    <div class="selection-card__body">
                                        <div class="selection-card__title" id="displayGuestName"></div>
                                        <div class="selection-card__meta">
                                            <span><i class="bi bi-phone"></i> <span id="displayGuestMobile"></span></span>
                                            <span><i class="bi bi-envelope"></i> <span id="displayGuestEmail"></span></span>
                                        </div>
                                    </div>
                        ...
                        <input type="hidden" name="guest_id" id="guestId" value="">
                        <input type="hidden" name="corporate_id" id="corporateId" value="">
                        ...
                        <div class="guest-hub__bottom">
                            ...
                            <div class="lookup-panel">
                                ...
                                <div id="corporateInfoDisplay" class="selection-card selection-card--corporate d-none">
                                    <div class="selection-card__icon">
                                        <i class="bi bi-buildings"></i>
                                    </div>
                                    <div class="selection-card__body">
                                        <div class="selection-card__title" id="displayCorporateName"></div>
                                        <div class="selection-card__meta">
                                            <span><i class="bi bi-percent"></i> <span id="displayCorporateDiscount"></span></span>
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-sm btn-outline-danger selection-card__remove"
                    ...
                    <div class="card-body-custom">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12 d-none" id="monthlyRateSection">
                                <!-- Monthly Rate Input -->
                                <div class="row g-2 mt-2" id="monthlyRateInputWrapper">
                                    <div class="col-md-4">
                                        <label class="form-label-custom">{{ __('dashboard.monthly_rate') }}</label>
                                        <input type="number" class="form-control" name="monthly_rate"
                                            id="monthlyRateInput" value="0" step="0.01" min="0">
                                    </div>
                                </div>

                                <!-- Rate Plan Dropdown for Monthly -->
                                <div class="row g-2 mt-2 d-none" id="monthlyRatePlanSelect">
                                    <div class="col-md-4">
                                        <label class="form-label-custom">{{ __('dashboard.rate_plan') }}</label>
                                        <select class="form-select" name="monthly_rate_plan_id" id="monthlyRatePlanSelectInput">
                                            <option value="">{{ __('dashboard.select_rate_plan') }}</option>
                                            @foreach ($ratePlans as $plan)
                                                <option value="{{ $plan->id }}"
                                                    data-monthly-rate="{{ $plan->unitTypeRates->first()?->pivot->monthly_rate ?? 0 }}">
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-8">
                                                ...
                                                <input type="number" class="form-control tax-fee-input"
                                                    ...
                                                    data-method="{{ $tax->method }}" data-amount="{{ $tax->amount }}">
                                            </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control" name="total_taxes_fees"
                                            id="totalTaxesFees" value="0" step="0.01" readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="payment_method_id" id="paymentMethod">
                                            ...
                                            @foreach ($paymentMethods as $method)
                                                <option value="{{ $method->id }}">{{ $method->paymentMethod->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control" name="security_deposit"
                                            id="securityDeposit" value="0" step="0.01" min="0">
                                    </div>
                                    <div class="col-md-3">
                ...
                <div class="action-buttons">
                    ...
                    <button type="button" class="btn btn-primary" onclick="saveReservation('check_in')">
                        <i class="bi bi-box-arrow-in-right me-1"></i>{{ __('dashboard.check_in') }}
                    </button>
                    <button type="button" class="btn btn-success" onclick="saveReservation('confirmed')">
                        <i class="bi bi-check-circle me-1"></i>{{ __('dashboard.confirm_reservation') }}
                    </button>
                </div>
            </form>
...
@push('scripts')
    <script>
            ...
            item.addEventListener('click', function() {
                ...
                fetch(ratesUrl)
                    ...
                    .then(data => {
                        ...
                        // Update rate display
                        updateRateDisplay();
                        // Auto-fill security deposit based on unit type
                        if (data.security_deposit !== undefined) {
                            document.getElementById('securityDeposit').value = parseFloat(data.security_deposit).toFixed(2);
                            calculateFinancials();
                        }
                    })
                    .catch(error => {
        ...
        // Function to check unit availability based on dates
        function checkUnitAvailability() {
            const checkIn = document.getElementById('checkInDate').value;
            const checkOut = document.getElementById('checkOutDate').value;
            const unitItems = document.querySelectorAll('.modal-unit-item');

            if (!checkIn || !checkOut || checkIn >= checkOut) {
                // Reset all units to available if dates are not valid
                unitItems.forEach(item => {
                    ...
                    if (statusBadge) {
                        statusBadge.className = 'status-badge status-available mt-1';
                        statusBadge.textContent = '{{ __('dashboard.available') }}';
                    }
                });
                return;
            }

            // Fetch unavailable units for the selected dates
            fetch('{{ route("dashboard.reservation.get_unavailable_units") }}?check_in_date=' + checkIn + '&check_out_date=' + checkOut)
                .then(response => response.json())
                .then(data => {
                    const unavailableUnitIds = data.unavailable_unit_ids || [];

                    unitItems.forEach(item => {
                        const unitId = parseInt(item.dataset.unitId);
                        if (unavailableUnitIds.includes(unitId)) {
                            item.classList.add('unavailable');
                            item.style.opacity = '0.5';
                            item.style.pointerEvents = 'none';
                            const statusBadge = item.querySelector('.status-badge');
                            if (statusBadge) {
                                statusBadge.className = 'status-badge status-booked mt-1';
                                statusBadge.textContent = '{{ __('dashboard.booked') }}';
                            }
                        } else {
                            item.classList.remove('unavailable');
                            item.style.opacity = '1';
        ...
        document.getElementById('unitModal').addEventListener('show.bs.modal', function() {
            ...
            // Check unit availability based on selected dates
        ...
        function findSelectedRatePlanUnitType(selectedPlanId) {
            if (!selectedPlanId) {
                return null;
            }

            const unitTypeIds = getSelectedUnitTypeIdsForRatePlan();

            return ratePlanUnitTypes.find(rate =>
                rate.rate_plan_id == selectedPlanId &&
                unitTypeIds.includes(String(rate.unit_type_id))
            ) || null;
        }

        function syncRatePlanSelection(selectedPlanId) {
            ['ratePlanSelectInput', 'monthlyRatePlanSelectInput'].forEach(selectId => {
                const select = document.getElementById(selectId);

                if (select && select.value !== selectedPlanId) {
                    select.value = selectedPlanId;
                }
            });
        }

        function clearRatePlanSelection() {
            syncRatePlanSelection('');
        }
        ...
        const initialOccupants = @json(old('occupants', []));
        let occupantEntries = [];
        ...
        function renderOccupants() {
            ...
            list.innerHTML = occupantEntries.map((entry, index) => `
        ...
        function searchOccupant() {
            ...
            resultsDiv.innerHTML = '<div class="lookup-results__state"><i class="fas fa-spinner fa-spin me-1"></i> Searching...</div>';
            ...
            document.querySelectorAll('input[name="rateOption"]').forEach(radio => {
                radio.addEventListener('change', function() {
                    ...
                    const dailyRateLabel = document.getElementById('dailyRateInput').querySelector(
                        'label');
                    const monthlyRateInputWrapper = document.getElementById('monthlyRateInputWrapper');
                    const monthlyRatePlanSelect = document.getElementById('monthlyRatePlanSelect');
                    ...
                    if (this.value === 'daily_rate' || this.value === 'monthly_rate') {
                        ...
                        monthlyRateInputWrapper.classList.remove('d-none');
                        monthlyRatePlanSelect.classList.add('d-none');
                        ...
                        // Show appropriate section based on reservation type
                        if (reservationType === 'monthly') {
                            dailyRateInput.classList.add('d-none');
                            monthlyRateInputWrapper.classList.remove('d-none');
                        } else {
                            dailyRateInput.classList.remove('d-none');
                            monthlyRateInputWrapper.classList.add('d-none');
                        }

                        // Make rate inputs editable
                        document.getElementById('dailyRate').readOnly = false;
                        document.getElementById('monthlyRateInput').readOnly = false;
                    } else {
                        // Rate plan selected - show rate input with values and dropdown
                        if (reservationType === 'monthly') {
                            dailyRateInput.classList.add('d-none');
                            ratePlanSelect.classList.add('d-none');
                            monthlyRateInputWrapper.classList.remove('d-none');
                            monthlyRatePlanSelect.classList.remove('d-none');
                            // Show monthly rate value (read-only)
                            document.getElementById('monthlyRateInput').readOnly = true;
                        } else {
                            dailyRateInput.classList.remove('d-none');
                            ratePlanSelect.classList.remove('d-none');
                            monthlyRateInputWrapper.classList.add('d-none');
                            monthlyRatePlanSelect.classList.add('d-none');
                            // Show daily rate value (read-only)
        ...
        function calculateFinancials() {
            ...
            // Total
            const total = subtotal - discount + totalTaxes;
        ...
        function selectGuest(id, name, mobile, email) {
            ...
            document.getElementById('displayGuestEmail').textContent = email || '-';
        ...
        function clearGuestInfo() {
            ...
            document.getElementById('displayGuestEmail').textContent = '';
        ...
        function searchCorporate() {
            ...
            fetch('{{ route("dashboard.corporate.search") }}?q=' + encodeURIComponent(query))
                ...
                .then(corporates => {
                    ...
                    let html = '';
                    const discountLabel = @json(__('dashboard.discount'));
                        ...
                        html += `
                            <button type="button" class="lookup-result-item"
                                ...
                                <span class="lookup-result-item__content">
                                    ...
                                    <span class="lookup-result-item__meta">${escapeHtml(discountLabel)}: ${escapeHtml(discount)}</span>
                                </span>
                                <span class="lookup-result-item__cta">
                                    <i class="bi bi-arrow-right"></i>
                                </span>
        ...
        function selectCorporate(id, name, discount) {
            ...
            document.getElementById('displayCorporateDiscount').textContent = '{{ __('dashboard.discount') }}: ' + discount;
        ...
        function saveReservation(status) {
                ...
                if (oldStatusInput) oldStatusInput.remove();
                const oldActionInput = form.querySelector('input[name="reservation_action"]');
                ...
                // Add reservation_action to form (keep original action for controller logic)
