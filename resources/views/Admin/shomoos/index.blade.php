...
@section('title', 'Shomoos Settings')
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            <div>
                                ...
                                <h4 class="mb-1">Shomoos Settings</h4>
                                <p class="text-muted mb-0">Keep this property in simulation mode until official credentials are approved.</p>
                            </div>
                            <span class="badge bg-light text-dark border">{{ strtoupper($setting->connection_status) }}</span>
                        </div>

                        <form method="POST" action="{{ route('setup-sidebar.shomoos.update') }}" class="row g-3">
                            @csrf
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label fw-semibold" for="enabled">Enable Shomoos for this property</label>
                                </div>
                                <small class="text-muted">Leave disabled if the hotel is not yet approved for integration.</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Live mode will be enabled after a real Shomoos or mediator driver is configured.</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="provider_name" class="form-control"
                                    value="{{ old('provider_name', $setting->provider_name) }}" placeholder="MOI / Partner provider">
                            </div>
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary">Save Shomoos Settings</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h5 class="mb-1">Recent Shomoos Activity</h5>
                                ...
                                <tbody>
                                    @forelse ($submissions as $submission)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('setup-sidebar.shomoos.show', $submission) }}" class="btn btn-sm btn-outline-primary">
                                                    View Details
                                                </a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted py-4">No Shomoos submissions yet.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
