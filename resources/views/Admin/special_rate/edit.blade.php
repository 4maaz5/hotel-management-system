...
@section('title', 'Edit Special Rate')
@section('content')
    ...
    <div class="container mt-4 bg-white p-3" style="border-radius:15px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold">{{ __('dashboard.edit_special_rate') }}</h2>

        </div>

        <form action="{{ route('setup-sidebar.special_rate.update', $seasonalRate->id) }}" method="POST">
            @csrf
            @method('PUT')
