...
@section('title', 'View tax and fee')
@section('content')
    <main class="u-white-bg bg-white p-3" style="border-radius:15px;">
        ...
        <div class="container mt-4">
            ...
            <div class="mb-4">
                <h4 class="fw-bold">
                    {{ __('dashboard.financial') }} - {{ __('dashboard.view_taxes_and_fees_customization') }}
                </h4>
            </div>
            ...
            <form action="{{ route('setup-sidebar.taxes.update', $tax->id) }}" method="POST">
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_expenses"
                                {{ $tax->is_expenses ? 'checked' : '' }} disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="custom_name" id="customNameDropdown" required disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="method" required disabled>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="checkAll"
                                {{ count($appliedOn) == 3 ? 'checked' : '' }} disabled>
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="charged_on_fees"
                                {{ $tax->charged_on_fees ? 'checked' : '' }} disabled>
                            <label class="form-check-label ms-2">
