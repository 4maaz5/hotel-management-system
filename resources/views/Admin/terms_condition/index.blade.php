...
@section('content')
    <main class="u-white-bg bg-white p-3" style="border-radius:15px;">
        ...
        <div class="page-header">
            <div>
                <h2 class="page-header__title">{{ __('dashboard.terms_and_conditions') }}</h2>
            </div>
            <div class="n-table__top-btns">
                ...
                <div>
                    @can('terms_and_condition.add')
                        <a href="{{ route('setup-sidebar.condition.create') }}" class="n-button n-button--green"
                            style="text-decoration:none;" tabindex="0">
                            {{ __('dashboard.new_term_and_condition') }}
                        </a>
                    @endcan
        ...
        <div class="collapse mb-3" id="filterCollapse">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('setup-sidebar.condition.index') }}">
                        <div class="row g-4 align-items-end">
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <input type="number" name="order_no" value="{{ request('order_no') }}" class="form-control"
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <input type="text" name="description" value="{{ request('description') }}"
                                    class="form-control" placeholder="{{ __('dashboard.enter_condition') }}">
                            </div>
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 pt-2">
                                ...
                                <a href="{{ route('setup-sidebar.condition.index') }}" class="btn btn-light border px-4">
                    ...
                    <table class="table table-bordered align-middle text-center">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th style="width:720px;">{{ __('dashboard.condition') }}</th>
                        ...
                        <tbody>
                            @forelse($conditions as $condition)
                                <tr>
                                    ...
                                    <td>
                                        @can('terms_and_condition.edit')
                                            <a href="{{ route('setup-sidebar.condition.edit', $condition->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                        @endcan

                                        @can('terms_and_condition.delete')
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteCustomRateModal{{ $condition->id }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-muted">
                                        {{ __('dashboard.no_conditions_found') }}
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    @foreach ($conditions as $condition)
        <div class="modal fade" id="deleteCustomRateModal{{ $condition->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{ __('dashboard.delete_condition') }}
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p>{{ __('dashboard.delete_condition_confirmation') }}</p>
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                            {{ __('dashboard.cancel') }}
                        </button>
                        <form action="{{ route('setup-sidebar.condition.delete', $condition->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
