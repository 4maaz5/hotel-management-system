...
@section('title', 'Dashboard | chatting')
@section('main')
    <!-- Main Content -->
    <div class="main-content">

        @include('Chatify::layouts.headLinks')
        <div class="messenger" style="width:1130px;">
            ...
            <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
                ...
                <div class="m-header">
                    <nav>
                        <a href="#"><i class="fas fa-inbox"></i> <span
                                class="messenger-headTitle">{{ __('dashboard.messages') }}</span> </a>
                        {{-- header buttons --}}
                ...
                <div class="m-body contacts-container">
                    ...
                    <div class="messenger-tab search-tab app-scroll" data-view="search">
                        {{-- items --}}
                        <p class="messenger-title"><span>{{ __('dashboard.search') }}</span></p>
            ...
            <div class="messenger-messagingView">
                ...
                <div class="m-header m-header-messaging">
                    ...
                    <div class="internet-connection">
                        ...
                        <span class="ic-noInternet">{{ __('dashboard.no_internet_access') }}</span>
                    </div>
                </div>
                ...
                <div class="m-body messages-container app-scroll">
                    <div class="messages">
                        <p class="message-hint center-el"><span>{{ __('dashboard.please_select_a_chat') }}</span></p>
                    </div>
                    {{-- Typing indicator --}}
